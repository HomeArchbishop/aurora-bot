...
import type { AdapterCompletionsParams, PlatformAdapter } from '@/extends/llm/internal/platform-adapters/interface'
import { buildUrl } from '@/utils/url'

export class SiliconflowAdapter implements PlatformAdapter {
